...
// const fetchData = async(searchValue = "bourne", pageNumber = 1) => {
//     const res = await (await fetch(`https://www.omdbapi.com?${API_KEY}&s=${searchValue}&page=${pageNumber}`)).json()
//     return res;
// }
...
//             }
//             pageNumber = 1;
//             const { Search: movies, totalResults } = await fetchData(searchResult, pageNumber);

//             searchResult = e.target.value;

//             if (pageNumber * 10 < totalResults || totalResults < 10) {
//                 searchedResultCount(totalResults, searchResult);
//             }
//             renderMovies(movies, totalResults)
//         };
...
//         const showMoreSearchedMovieResult = (searchResult) => {
//             pageNumber++;
//             fetchData(searchResult, pageNumber);
